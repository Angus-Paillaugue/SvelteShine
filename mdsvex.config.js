...
import { imageTransformer, linkTransformer } from './src/lib/transformer.js';
...
const config = {
  ...
  remarkPlugins: [remarkMath, remarkAttr, imageTransformer, linkTransformer, remarkCodeTitles],
